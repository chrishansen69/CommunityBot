...
function func() {
  if (typeof exports === 'undefined') {
    this.sax = {};  // jshint ignore:line
    return this.sax;  // jshint ignore:line
  } else {
    return exports;
  }
}
...
;(function (sax) { // wrapper for non-node envs
  ...
  function closeTag (parser) {
    ...
    while (s-- > t) {
      ...
      if (parser.opt.xmlns && tag.ns !== parent.ns) {
        ...
        Object.keys(tag.ns).forEach(function (p) { // jshint ignore:line
          const n = tag.ns[p];
  ...
  function write (chunk) {
    const parser = this;  // jshint ignore:line
    if (this.error) {  // jshint ignore:line
      throw this.error;  // jshint ignore:line
    }
    if (parser.closed) {
      return error(parser,
