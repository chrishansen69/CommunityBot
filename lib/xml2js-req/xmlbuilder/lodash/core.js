...
;(function() {
 ...
 const isSameTag = objTag == othTag;
    ...
    stack || (stack = []);
    const stacked = find(stack, function(entry) {
 ...
 const othLength = other.length;
    ...
    let index = -1;
 let result = true;
 const seen = (bitmask & UNORDERED_COMPARE_FLAG) ? [] : undefined;
 ...
 const array = Array(length);
  ...
  function has(object, path) {
    return (object !== null && object !== undefined) && hasOwnProperty.call(object, path);
  }
  ...
  const pick = rest(function(object, props) {
    return (object === null || object === undefined) ? {} : basePick(object, baseMap(baseFlatten(props, 1), toKey));
  });
  ...
  function result(object, path, defaultValue) {
    let value = (object === null || object === undefined) ? undefined : object[path];
    if (value === undefined) {
      value = defaultValue;
    }
