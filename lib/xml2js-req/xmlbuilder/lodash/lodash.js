...
;(function() {
 ...
 const rsUpperMisc = '(?:' + rsUpper + '|' + rsMisc + ')';
 const rsOptLowerContr = '(?:' + rsApos + '(?:d|ll|m|re|s|t|ve))?';
 const rsOptUpperContr = '(?:' + rsApos + '(?:D|LL|M|RE|S|T|VE))?';
 ...
 const rsSymbol = '(?:' + [rsNonAstral + rsCombo + '?', rsCombo, rsRegional, rsSurrPair, rsAstral].join('|') + ')';
  ...
  const reHasComplexWord = /[a-z][A-Z]|[A-Z]{2,}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/;
 ...
 const TypeError = context.TypeError;
    ...
    const arrayProto = context.Array.prototype;
 const objectProto = context.Object.prototype;
 const stringProto = context.String.prototype;
    ...
    const funcToString = context.Function.prototype.toString;
 ...
 const splice = arrayProto.splice;
    ...
    const setTimeout = function(func, wait) { return context.setTimeout.call(root, func, wait); };
 ...
 const index = assocIndexOf(data, key);
    ...
    function baseAt(object, paths) {
      let index = -1;
 const isNil = (object === null || object === undefined);
 ...
 const current = iteratee(value);
        ...
        if ((current !== null && current !== undefined) && (computed === undefined
 ...
 const computed = iteratee ? iteratee(value) : value;
    ...
    function baseIsEqual(value, other, customizer, bitmask, stack) {
      ...
      if ((value === null || value === undefined) || (other === null || other === undefined) || (!isObject(value) && !isObjectLike(other))) {
 ...
 const otherFunc = data.func;
        if ((otherFunc === null || otherFunc === undefined) || otherFunc == func) {
          return data.name;
        }
      }
      return result;
 ...
 const result = array.constructor(length);
    ...
    function indexKeys(object) {
      const length = object ? object.length : undefined;
      if (isLength(length) &&
          (isArray(object) || isString(object) || isArguments(object))) {
    ...
    function isIndex(value, length) {
      length = (length === null || length === undefined) ? MAX_SAFE_INTEGER : length;
      return !!length &&
    ...
    function isKey(value, object) {
      ...
      if (type == 'number' || type == 'symbol' || type == 'boolean' ||
          (value === null || value === undefined) || isSymbol(value)) {
        return true;
      }
 ...
 const isCommon = newBitmask < (BIND_FLAG | BIND_KEY_FLAG | ARY_FLAG);
 ...
 let index = length;
     ...
     * // => [1]
     */
    const difference = rest(function(array, values) {
     ...
     * // => [{ 'x': 2 }]
     */
    const differenceBy = rest(function(array, values) {
    ...
    function findIndex(array, predicate, fromIndex) {
      ...
      let index = (fromIndex === null || fromIndex === undefined) ? 0 : toInteger(fromIndex);
      if (index < 0) {
 ...
 const result = {};
     ...
     * // => [{ 'x': 1 }]
     */
    const intersectionBy = rest(function(arrays) {
 ...
 const indexes = [];
    ...
    function slice(array, start, end) {
      ...
      if (end && typeof end != 'number' && isIterateeCall(array, start, end)) {
        ...
        start = (start === null || start === undefined) ? 0 : toInteger(start);
     ...
     * // => [2, 1]
     */
    const union = rest(function(arrays) {
     ...
     * // => [{ 'x': 1 }, { 'x': 2 }]
     */
    const unionBy = rest(function(arrays) {
      let iteratee = last(arrays);
      if (isArrayLikeObject(iteratee)) {
        iteratee = undefined;
      }
     ...
     */
    const unionWith = rest(function(arrays) {
      let comparator = last(arrays);
      if (isArrayLikeObject(comparator)) {
        comparator = undefined;
      }
     ...
     * // => [1, 3]
     */
    const xor = rest(function(arrays) {
     ...
     * // => [{ 'x': 2 }]
     */
    const xorBy = rest(function(arrays) {
      let iteratee = last(arrays);
      if (isArrayLikeObject(iteratee)) {
        iteratee = undefined;
      }
     ...
     * // => [{ 'x': 2, 'y': 1 }, { 'x': 1, 'y': 1 }]
     */
    const xorWith = rest(function(arrays) {
      let comparator = last(arrays);
      if (isArrayLikeObject(comparator)) {
        comparator = undefined;
      }
     ...
     * // => [111, 222]
     */
    const zipWith = rest(function(arrays) {
      const length = arrays.length;
 ...
 let parent = this;
     ...
     * // => [['1', '2', '3'], ['4', '5', '6']]
     */
    const invokeMap = rest(function(collection, path, args) {
      let index = -1;
 const isFunc = typeof path == 'function';
 const isProp = isKey(path);
 const result = isArrayLike(collection) ? Array(collection.length) : [];

      baseEach(collection, function(value) {
        const func = isFunc ? path : ((isProp && (value !== null && value !== undefined)) ? value[path] : undefined);
    ...
    function orderBy(collection, iteratees, orders, guard) {
      ...
      if (!isArray(iteratees)) {
        iteratees = (iteratees === null || iteratees === undefined) ? [] : [iteratees];
      }
      orders = guard ? undefined : orders;
      if (!isArray(orders)) {
        orders = (orders === null || orders === undefined) ? [] : [orders];
      }
 ...
 const initAccum = arguments.length < 3;
    ...
    function sampleSize(collection, n, guard) {
      let index = -1;
 const result = toArray(collection);
 ...
 const value = result[rand];
     ...
     * // => objects for [['barney', 36], ['barney', 34], ['fred', 48], ['fred', 40]]
     */
    const sortBy = rest(function(collection, iteratees) {
      if ((collection === null || collection === undefined)) {
        return [];
      }
    ...
    function ary(func, n, guard) {
      n = guard ? undefined : n;
      n = (func && (n === null || n === undefined)) ? func.length : n;
     ...
     * // => 'hi fred!'
     */
    const bind = rest(function(func, thisArg, partials) {
      let bitmask = BIND_FLAG;
      if (partials.length) {
     ...
     * // => 'hiya fred!'
     */
    const bindKey = rest(function(object, key, partials) {
      let bitmask = BIND_FLAG | BIND_KEY_FLAG;
      if (partials.length) {
    ...
    function curry(func, arity, guard) {
      ...
      const result = createWrapper(func, CURRY_FLAG, undefined, undefined, undefined, undefined, undefined, arity);
    ...
    function curryRight(func, arity, guard) {
      arity = guard ? undefined : arity;
      const result = createWrapper(func, CURRY_RIGHT_FLAG, undefined, undefined, undefined, undefined, undefined, arity);
 ...
 const isInvoking = shouldInvoke(time);
     ...
     */
    const defer = rest(function(func, args) {
     ...
     */
    const delay = rest(function(func, wait, args) {
 ...
 const cache = memoized.cache;
     ...
     * // => 'hi fred'
     */
    const partial = rest(function(func, partials) {
     ...
     * // => 'hello fred'
     */
    const partialRight = rest(function(func, partials) {
     ...
     * // => ['a', 'b', 'c']
     */
    const rearg = rest(function(func, indexes) {
 ...
 let trailing = true;
    ...
    function wrap(value, wrapper) {
      wrapper = (wrapper === null || wrapper === undefined) ? identity : wrapper;
    ...
    function isArrayLike(value) {
      return (value !== null && value !== undefined) && isLength(getLength(value)) && !isFunction(value);
    }
 ...
 const remainder = result % 1;
    ...
    function toNumber(value) {
      ...
      if (isObject(value)) {
        const other = isFunction(value.valueOf) ? value.valueOf() : value;
     ...
     * // => { 'user': 'barney', 'age': 36 }
     */
    const defaults = rest(function(args) {
     ...
     *
     */
    const defaultsDeep = rest(function(args) {
    ...
    function functions(object) {
      return (object === null || object === undefined) ? [] : baseFunctions(object, keys(object));
    }
    ...
    function functionsIn(object) {
      return (object === null || object === undefined) ? [] : baseFunctions(object, keysIn(object));
    }
    ...
    function get(object, path, defaultValue) {
      const result = (object === null || object === undefined) ? undefined : baseGet(object, path);
    ...
    function has(object, path) {
      return (object !== null && object !== undefined) && hasPath(object, path, baseHas);
    }
    ...
    function hasIn(object, path) {
      return (object !== null && object !== undefined) && hasPath(object, path, baseHasIn);
    }
 ...
 const result = indexes || [];
    ...
    function pickBy(object, predicate) {
      return (object === null || object === undefined) ? {} : basePickBy(object, getIteratee(predicate));
    }
    ...
    function result(object, path, defaultValue) {
      ...
      while (++index < length) {
        let value = (object === null || object === undefined) ? undefined : object[toKey(path[index])];
        if (value === undefined) {
          index = length;
          value = defaultValue;
        }
    ...
    function setWith(object, path, value, customizer) {
      customizer = typeof customizer == 'function' ? customizer : undefined;
      return (object === null || object === undefined) ? object : baseSet(object, path, value, customizer);
    }
    ...
    function transform(object, iteratee, accumulator) {
      const isArr = isArray(object) || isTypedArray(object);
    ...
    function unset(object, path) {
      return (object === null || object === undefined) ? true : baseUnset(object, path);
    }
    ...
    function update(object, path, updater) {
      return (object === null || object === undefined) ? object : baseUpdate(object, path, castFunction(updater));
    }
    ...
    function updateWith(object, path, updater, customizer) {
      customizer = typeof customizer == 'function' ? customizer : undefined;
      return (object === null || object === undefined) ? object : baseUpdate(object, path, castFunction(updater), customizer);
    }
    ...
    function valuesIn(object) {
      return (object === null || object === undefined) ? [] : baseValues(object, keysIn(object));
    }
    ...
    function parseInt(string, radix, guard) {
      ...
      if (guard || (radix === null || radix === undefined)) {
        radix = 0;
      } else if (radix) {
        radix = +radix;
      }
 ...
 const string = toString(args[0]);
    ...
    function template(string, options, guard) {
      ...
      const imports = assignInWith({}, options.imports, settings.imports, assignInDefaults);
 ...
 const substring = result;
     ...
     * }
     */
    const attempt = rest(function(func, args) {
      try {
     ...
     */
    const bindAll = rest(function(object, methodNames) {
 ...
 const toIteratee = getIteratee();
     ...
     * // => [2, 1]
     */
    const method = rest(function(path, args) {
      return function(object) {
     ...
     * // => [2, 0]
     */
    const methodOf = rest(function(object, args) {
 ...
 const actions = result.__actions__ = copyArray(this.__actions__);
    ...
    function propertyOf(object) {
      return function(path) {
        return (object === null || object === undefined) ? undefined : baseGet(object, path);
      };
    }
    ...
    arrayEach(['drop', 'take'], function(methodName, index) {
      LazyWrapper.prototype[methodName] = function(n) {
        const filtered = this.__filtered__;
        if (filtered && !index) {
 ...
 const names = realNames[key] || (realNames[key] = []);
