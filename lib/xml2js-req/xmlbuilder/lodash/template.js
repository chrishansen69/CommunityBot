'use strict';
const assignInDefaults = require('./_assignInDefaults');
 const assignInWith = require('./assignInWith');
 const attempt = require('./attempt');
 const baseValues = require('./_baseValues');
 const escapeStringChar = require('./_escapeStringChar');
 const isError = require('./isError');
 const isIterateeCall = require('./_isIterateeCall');
 const keys = require('./keys');
 const reInterpolate = require('./_reInterpolate');
...
function template(string, options, guard) {
  ...
  const settings = templateSettings.imports._.templateSettings || templateSettings;
