...
//
//     // Save the new config
//     configModule.save(newConfig, function(error) {
//         if (error) {
//             console.error(error);
//             bot.sendMessage({
//                 to: channelID,
...
function enableCommand(user, userID, channelID, message) {
    ...
    enablePlugin(pluginName, function(error) {
...
function renameCommand(user, userID, channelID, message) {
    ...
    configModule.rename(message, function(error) {
        if (error) {
            bot.sendMessage({
                to: channelID,
...
function opCommand(user, userID, channelID, message) {
    ...
    configModule.op(operatorID, message, function(error) {
        if (error) {
            bot.sendMessage({
                to: channelID,
...
function deopCommand(user, userID, channelID, message) {
    ...
    configModule.deop(operatorID, message, function(error) {
...
function prefixCommand(user, userID, channelID, message) {
    ...
    configModule.prefix(newPrefix, function(error) {
        if (error) {
            bot.sendMessage({
                to: channelID,
...
function ownerCommand(user, userID, channelID, message) {
    ...
    configModule.prefix(newOwner, function(error) {
        if (error) {
            bot.sendMessage({
                to: channelID,
...
function reloadCommand(user, userID, channelID) {
    configModule.reload(function(error) {
        if (error) {
            bot.sendMessage({
                to: channelID,
...
function avatarCommand(user, userID, channelID, message) {
    ...
    configModule.avatar(path, function(error) {
        if (error) {
            bot.sendMessage({
                to: channelID,
